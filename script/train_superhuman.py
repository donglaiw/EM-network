...
def load_data(args):
    ...
    augmentor = 1
    train_dataset = AffinityDataset(volume=train_input, label=train_label, sample_input_size=args.data_shape,
                                    sample_label_size=args.data_shape, augmentor=augmentor, mode='train')
    valid_dataset = AffinityDataset(volume=validation_input, label=validation_label, sample_input_size=args.data_shape,
                                    sample_label_size=args.data_shape, augmentor=augmentor, mode='train')
